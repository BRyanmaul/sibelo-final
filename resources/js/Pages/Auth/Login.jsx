                ...
                <form onSubmit={submit}>
                    ...
                    <div className="flex items-center justify-end mt-4">
                        {canResetPassword && (
                            <Link
                                href={route('register')}
                                className="btn-glass scale-90 text-orange-800 mt-3  hover:bg-primary hover:scale-105 text-xl"
                            >
                                register
                            </Link>
                        )}

                        <PrimaryButton className="btn glass bg-orange-400 text-orange-800 mt-3  hover:bg-primary  text-xl hover:scale-105 transition duration-500" disabled={processing}>
                            Log in
                        </PrimaryButton>
                    </div>
                </form>
